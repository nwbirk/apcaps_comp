...
# 2/02/25
# This is the script that will consider only the non-zero coefficient
# variables from LASSO and refit the other models.

# The general processing steps will remain the same.
...
lasso_coefs <- read.csv("~/lasso_coefs.csv")
# Remove the first column, instead lef it be column names
lasso_coefs2 <- lasso_coefs[,2:ncol(lasso_coefs)]
rownames(lasso_coefs2) = lasso_coefs$X
lasso_coefs = lasso_coefs2
...
# Function to save model
make_rf2 <- function(outcome_var, sex, rownum){
  if(sex == 'male'){
    ...
    dxa_train_male_sub <- dxa_train_male %>% dplyr::select(colnames(lasso_coefs)[lasso_coefs[rownum,]>0], 
                                                           "ha1q34_6dtrunk_pcent_fat", "ha1q34_12dl1l4_pcent1", "ha1q34_9atotal_fat", 
                                                           "ha1q34_9btotal_lean", "ha1q34_9dtotal_pcent_fat", "appendic_fat", "appendic_lean")
    ...
    dxa_train_female_sub <- dxa_train_female %>% dplyr::select(colnames(lasso_coefs)[lasso_coefs[rownum,]>0], 
                                                           "ha1q34_6dtrunk_pcent_fat", "ha1q34_12dl1l4_pcent1", "ha1q34_9atotal_fat", 
                                                           "ha1q34_9btotal_lean", "ha1q34_9dtotal_pcent_fat", "appendic_fat", "appendic_lean")
    
    
    rf1 <- caret::train(form,  
                        dxa_train_female_sub, 
                        tuneLength = 5,
                        method = "ranger",
                        trControl = trainControl(method = "cv", 
                                                 number = 10, 
...
# Function to save model
make_xgb2 <- function(outcome_var, sex, rownum){
  if(sex == 'male'){
    form <- as.formula(paste(outcome_var, '~ .  -ha1q34_6dtrunk_pcent_fat - ha1q34_12dl1l4_pcent1 - ha1q34_9atotal_fat - ha1q34_9btotal_lean - ha1q34_9dtotal_pcent_fat - appendic_fat - appendic_lean'))
...
tot_fat_male_rf <- make_rf2('ha1q34_9atotal_fat', 'male', rownum = 6)
tot_fat_male_xgb <- make_xgb2('ha1q34_9atotal_fat', 'male', rownum = 6)
tot_fat_female_lasso <- make_lasso('ha1q34_9atotal_fat', 'female')
tot_fat_female_rf <- make_rf2('ha1q34_9atotal_fat', 'female', rownum = 5)
tot_fat_female_xgb <- make_xgb2('ha1q34_9atotal_fat', 'female', rownum = 5)
...
tot_lean_male_rf <- make_rf2('ha1q34_9btotal_lean', 'male', rownum = 8)
tot_lean_male_xgb <- make_xgb2('ha1q34_9btotal_lean', 'male', rownum = 8)
tot_lean_female_lasso <- make_lasso('ha1q34_9btotal_lean', 'female')
tot_lean_female_rf <- make_rf2('ha1q34_9btotal_lean', 'female', rownum = 7)
tot_lean_female_xgb <- make_xgb2('ha1q34_9btotal_lean', 'female', rownum = 7)
...
totalleanresults <- rbind(tlm1, tlm2, tlm3, tlm4, tlm5, tlm6, tlm7, tlm8)
...
tot_p_male_rf <- make_rf2('ha1q34_9dtotal_pcent_fat', 'male', rownum = 10)
tot_p_male_xgb <- make_xgb2('ha1q34_9dtotal_pcent_fat', 'male', rownum = 10)
tot_p_female_lasso <- make_lasso('ha1q34_9dtotal_pcent_fat', 'female')
tot_p_female_rf <- make_rf2('ha1q34_9dtotal_pcent_fat', 'female', rownum = 9)
tot_p_female_xgb <- make_xgb2('ha1q34_9dtotal_pcent_fat', 'female', rownum = 9)
...
trunk_fat_male_rf <- make_rf2('ha1q34_6dtrunk_pcent_fat', 'male', rownum = 12)
trunk_fat_male_xgb <- make_xgb2('ha1q34_6dtrunk_pcent_fat', 'male', rownum = 12)
trunk_fat_female_lasso <- make_lasso('ha1q34_6dtrunk_pcent_fat', 'female')
trunk_fat_female_rf <- make_rf2('ha1q34_6dtrunk_pcent_fat', 'female', rownum = 11)
trunk_fat_female_xgb <- make_xgb2('ha1q34_6dtrunk_pcent_fat', 'female', rownum = 11)
...
l1_fat_male_rf <- make_rf2('ha1q34_12dl1l4_pcent1', 'male', rownum = 4)
l1_fat_male_xgb <- make_xgb2('ha1q34_12dl1l4_pcent1', 'male', rownum = 4)
l1_fat_female_lasso <- make_lasso('ha1q34_12dl1l4_pcent1', 'female')
l1_fat_female_rf <- make_rf2('ha1q34_12dl1l4_pcent1', 'female', rownum = 3)
l1_fat_female_xgb <- make_xgb2('ha1q34_12dl1l4_pcent1', 'female', rownum = 3)
...
app_lean_male_rf <- make_rf2('appendic_lean', 'male', rownum = 2)
app_lean_male_xgb <- make_xgb2('appendic_lean', 'male', rownum = 2)
app_lean_female_lasso <- make_lasso('appendic_lean', 'female')
app_lean_female_rf <- make_rf2('appendic_lean', 'female', rownum = 1)
app_lean_female_xgb <- make_xgb2('appendic_lean', 'female', rownum = 1)
...
# EXPORT RESULTS
write.csv(totalfatresults, 'totalfatmasslessintslesspreds.csv')
write.csv(totalleanresults, 'totalleanmasslessintslesspreds.csv')
write.csv(totalfatpresults, 'totalfatpercentlessintslesspreds.csv')
write.csv(trunkpercent, 'trunkfatpercentlessintslesspreds.csv')
write.csv(l1results, 'l1l4fatpercentlessintslesspreds.csv')
write.csv(apresults, 'appleanmasslessintslesspreds.csv')
