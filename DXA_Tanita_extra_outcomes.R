# DXA vs Tanita study EXTRA OUTCOMES
...
wave3 <- wave3 %>% mutate(ha1q34_10al1l4_fat1 = (ha1q34_10al1l4_fat1 + ha1q34_12al1l4_fat1)/2,
                          ha1q34_10bl1l4_lean1 = (ha1q34_10bl1l4_lean1 + ha1q34_12bl1l4_lean1)/2)
...
our_variables <- c('ha1q34_9atotal_fat', 'ha1q34_9btotal_lean', 'ha1q34_9dtotal_pcent_fat',
                   ...
                   'ha1q34_4blarm_lean', 'ha1q34_5brarm_lean',
                   'ha1q34_7blleg_lean', 'ha1q34_8brleg_lean',
                   
                   'ha1q34_6atrunk_fat', 'ha1q34_6btrunk_lean', 
                   'ha1q34_10al1l4_fat1', 'ha1q34_10bl1l4_lean1',
                   'ha1q34_4alarm_fat', 'ha1q34_4clarm_mass', 'ha1q34_5ararm_fat', 'ha1q34_5crarm_mass',
                   'ha1q34_7alleg_fat', 'ha1q34_7clleg_mass', 'ha1q34_8arleg_fat', 'ha1q34_8crleg_mass',
...
avg_measures <- function(data){
  data <- data %>% 
    mutate(calf_circ = (ha1q25_10acalf_circ1 + ha1q25_10bcalf_circ2)/2,
           ...
           appendic_perc = (ha1q34_4alarm_fat + ha1q34_5ararm_fat + ha1q34_7alleg_fat + ha1q34_8arleg_fat)/(ha1q34_4clarm_mass + ha1q34_5crarm_mass + ha1q34_7clleg_mass + ha1q34_8crleg_mass)) %>%
    select(-c('ha1q34_9atotal_fat', 'ha1q34_9btotal_lean', 'ha1q34_9dtotal_pcent_fat',
              'ha1q34_6dtrunk_pcent_fat', 
              'ha1q34_12dl1l4_pcent1',
              'ha1q34_4blarm_lean', 'ha1q34_5brarm_lean',
              'ha1q34_7blleg_lean', 'ha1q34_8brleg_lean',
      'ha1q25_10acalf_circ1', 'ha1q25_10bcalf_circ2', 
              'ha1q25_11ahead_circ1', 'ha1q25_11bhead_circ2', 'ha1q25_11iachest_i_circ1', 
              'ha1q25_11ibchest_i_circ2', 'ha1q25_11iiachest_e_circ1', 'ha1q25_11iibchest_e_circ2', 
              'ha1q25_7awaist_circ1', 'ha1q25_7bwaist_circ2', 'ha1q25_8ahip_circ1', 
              'ha1q25_8bhip_circ2', 'ha1q25_9aarm_circ1', 'ha1q25_9barm_circ2', 'ha1q25_12atricep1',
...
make_lasso <- function(outcome_var, sex){
  if(sex == 'male'){
    trainmat <- dxa_train_male %>% select(colnames(dxa_train_male)[c(9:53, 56:72)]) %>% as.matrix()
    ...
    trainmat <- dxa_train_female %>% select(colnames(dxa_train_female)[c(9:53, 56:72)]) %>% as.matrix()
...
# TO DO: CORRECT VARIABLE LIST

# Function to save model
make_rf <- function(outcome_var, sex){
  if(sex == 'male'){
    form <- as.formula(paste(outcome_var, '~ . -ha1q34_6atrunk_fat - ha1q34_6btrunk_lean - ha1q34_10al1l4_fat1 - ha1q34_10bl1l4_lean1 - ha1q34_4clarm_mass - ha1q34_5crarm_mass - ha1q34_7clleg_mass - ha1q34_8crleg_mass - appendic_fat - appendic_perc'))
...
predict_enet <- function(model, dataset){
  return(as.numeric((dataset %>% select(colnames(dataset)[c(9:53, 56:72)]) %>% as.matrix() %*% model$beta) + model$a0))
}
...
# Outcome = Trunk fat mass

# Models
trunk_fat_male_lasso <- make_lasso('ha1q34_6atrunk_fat', 'male')
trunk_fat_male_rf <- make_rf('ha1q34_6atrunk_fat', 'male')
trunk_fat_male_xgb <- make_xgb('ha1q34_6atrunk_fat', 'male')
trunk_fat_female_lasso <- make_lasso('ha1q34_6atrunk_fat', 'female')
trunk_fat_female_rf <- make_rf('ha1q34_6atrunk_fat', 'female')
trunk_fat_female_xgb <- make_xgb('ha1q34_6atrunk_fat', 'female')

# Performance
tfm1 <- train_test_perf(1000*dxa_train_male[,'ha1q37_11ii_seg_tr_mass'], 
                        1000*dxa_test_male[,'ha1q37_11ii_seg_tr_mass'], 
                        'ha1q34_6atrunk_fat', 'male')
tfm2 <- train_test_perf(predict_enet(trunk_fat_male_lasso, dxa_train_male), 
                        predict_enet(trunk_fat_male_lasso, dxa_test_male),
                        'ha1q34_6atrunk_fat', 'male')
tfm3 <- train_test_perf(predict(trunk_fat_male_rf, dxa_train_male)$predictions, 
                        predict(trunk_fat_male_rf, dxa_test_male)$predictions,
                        'ha1q34_6atrunk_fat', 'male')
tfm4 <- train_test_perf(predict(trunk_fat_male_xgb, dxa_train_male), 
                        predict(trunk_fat_male_xgb, dxa_test_male),
                        'ha1q34_6atrunk_fat', 'male')


tfm5 <- train_test_perf(1000*dxa_train_female[,'ha1q37_11ii_seg_tr_mass'], 
                        1000*dxa_test_female[,'ha1q37_11ii_seg_tr_mass'], 
                        'ha1q34_6atrunk_fat', 'female')
tfm6 <- train_test_perf(predict_enet(trunk_fat_female_lasso, dxa_train_female), 
                        predict_enet(trunk_fat_female_lasso, dxa_test_female),
                        'ha1q34_6atrunk_fat', 'female')
tfm7 <- train_test_perf(predict(trunk_fat_female_rf, dxa_train_female)$predictions, 
                        predict(trunk_fat_female_rf, dxa_test_female)$predictions,
                        'ha1q34_6atrunk_fat', 'female')
tfm8 <- train_test_perf(predict(trunk_fat_female_xgb, dxa_train_female), 
                        predict(trunk_fat_female_xgb, dxa_test_female),
                        'ha1q34_6atrunk_fat', 'female')

trunkfatresults <- rbind(tfm1, tfm2, tfm3, tfm4, tfm5, tfm6, tfm7, tfm8)

# plots
p1 = blandr.draw(predict_enet(trunk_fat_male_lasso, dxa_test_male), 
                 dxa_test_male[,'ha1q34_6atrunk_fat'], lowest_y_axis = -10000, highest_y_axis = 10000,
                 plotTitle = "Trunk fat mass (g), male, Full LASSO", ciShading = FALSE, ciDisplay = FALSE) 
p2 = blandr.draw(predict_enet(trunk_fat_female_lasso, dxa_test_female), 
                 dxa_test_female[,'ha1q34_6atrunk_fat'], lowest_y_axis = -10000, highest_y_axis = 10000,
                 plotTitle = "Trunk fat mass (g), female, Full LASSO", ciShading = FALSE, ciDisplay = FALSE) 


p3 = blandr.draw(1000*dxa_test_male[,'ha1q37_11ii_seg_tr_mass'], 
                 dxa_test_male[,'ha1q34_6atrunk_fat'], lowest_y_axis = -10000, highest_y_axis = 10000,
                 plotTitle = "Trunk fat mass (g), male, Tanita", ciShading = FALSE, ciDisplay = FALSE) 
p4 = blandr.draw(1000*dxa_test_female[,'ha1q37_11ii_seg_tr_mass'], 
                 dxa_test_female[,'ha1q34_6atrunk_fat'], lowest_y_axis = -10000, highest_y_axis = 10000,
                 plotTitle = "Trunk fat mass (g), female, Tanita", ciShading = FALSE, ciDisplay = FALSE) 
...
# Outcome = Trunk lean mass, ha1q34_6btrunk_lean

# Models
trunk_lean_male_lasso <- make_lasso('ha1q34_6btrunk_lean', 'male')
trunk_lean_male_rf <- make_rf('ha1q34_6btrunk_lean', 'male')
trunk_lean_male_xgb <- make_xgb('ha1q34_6btrunk_lean', 'male')
trunk_lean_female_lasso <- make_lasso('ha1q34_6btrunk_lean', 'female')
trunk_lean_female_rf <- make_rf('ha1q34_6btrunk_lean', 'female')
trunk_lean_female_xgb <- make_xgb('ha1q34_6btrunk_lean', 'female')

# Performance
tlm1 <- train_test_perf(1000*dxa_train_male[,'ha1q37_11iii_seg_tr_free_mass'], 
                        1000*dxa_test_male[,'ha1q37_11iii_seg_tr_free_mass'], 
                        'ha1q34_6btrunk_lean', 'male')
tlm2 <- train_test_perf(predict_enet(trunk_lean_male_lasso, dxa_train_male), 
                        predict_enet(trunk_lean_male_lasso, dxa_test_male),
                        'ha1q34_6btrunk_lean', 'male')
tlm3 <- train_test_perf(predict(trunk_lean_male_rf, dxa_train_male)$predictions, 
                        predict(trunk_lean_male_rf, dxa_test_male)$predictions,
                        'ha1q34_6btrunk_lean', 'male')
tlm4 <- train_test_perf(predict(trunk_lean_male_xgb, dxa_train_male), 
                        predict(trunk_lean_male_xgb, dxa_test_male),
                        'ha1q34_6btrunk_lean', 'male')


tlm5 <- train_test_perf(1000*dxa_train_female[,'ha1q37_11iii_seg_tr_free_mass'], 
                        1000*dxa_test_female[,'ha1q37_11iii_seg_tr_free_mass'], 
                        'ha1q34_6btrunk_lean', 'female')
tlm6 <- train_test_perf(predict_enet(trunk_lean_female_lasso, dxa_train_female), 
                        predict_enet(trunk_lean_female_lasso, dxa_test_female),
                        'ha1q34_6btrunk_lean', 'female')
tlm7 <- train_test_perf(predict(trunk_lean_female_rf, dxa_train_female)$predictions, 
                        predict(trunk_lean_female_rf, dxa_test_female)$predictions,
                        'ha1q34_6btrunk_lean', 'female')
tlm8 <- train_test_perf(predict(trunk_lean_female_xgb, dxa_train_female), 
                        predict(trunk_lean_female_xgb, dxa_test_female),
                        'ha1q34_6btrunk_lean', 'female')

# plots
p1 = blandr.draw(predict_enet(trunk_lean_male_lasso, dxa_test_male), 
                 dxa_test_male[,'ha1q34_6btrunk_lean'],
                 plotTitle = "Trunk lean mass (g), male, Full LASSO", ciShading = FALSE, ciDisplay = FALSE) 
p2 = blandr.draw(predict_enet(trunk_lean_female_lasso, dxa_test_female), 
                 dxa_test_female[,'ha1q34_6btrunk_lean'],
                 plotTitle = "Trunk lean mass (g), female, Full LASSO", ciShading = FALSE, ciDisplay = FALSE) 


p3 = blandr.draw(1000*dxa_test_male[,'ha1q37_11iii_seg_tr_free_mass'], 
                 dxa_test_male[,'ha1q34_6btrunk_lean'],
                 plotTitle = "Trunk lean mass (g), male, Tanita", ciShading = FALSE, ciDisplay = FALSE) 
p4 = blandr.draw(1000*dxa_test_female[,'ha1q37_11iii_seg_tr_free_mass'], 
                 dxa_test_female[,'ha1q34_6btrunk_lean'],
                 plotTitle = "Trunk lean mass (g), female, Tanita", ciShading = FALSE, ciDisplay = FALSE) 
...
trunkleanresults <- rbind(tlm1, tlm2, tlm3, tlm4, tlm5, 
                          tlm6, tlm7, tlm8)



# Outcome = L1-L4 fat mass, ha1q34_10al1l4_fat1


# Models
l1_fat_male_lasso <- make_lasso('ha1q34_10al1l4_fat1', 'male')
l1_fat_male_rf <- make_rf('ha1q34_10al1l4_fat1', 'male')
l1_fat_male_xgb <- make_xgb('ha1q34_10al1l4_fat1', 'male')
l1_fat_female_lasso <- make_lasso('ha1q34_10al1l4_fat1', 'female')
l1_fat_female_rf <- make_rf('ha1q34_10al1l4_fat1', 'female')
l1_fat_female_xgb <- make_xgb('ha1q34_10al1l4_fat1', 'female')

# Performance
l11 <- train_test_perf(1000*dxa_train_male[,'ha1q37_11ii_seg_tr_mass'], 
                        1000*dxa_test_male[,'ha1q37_11ii_seg_tr_mass'], 
                        'ha1q34_10al1l4_fat1', 'male')
...
l15 <- train_test_perf(1000*dxa_train_female[,'ha1q37_11ii_seg_tr_mass'], 
                        1000*dxa_test_female[,'ha1q37_11ii_seg_tr_mass'], 
                        'ha1q34_10al1l4_fat1', 'female')
...
l1fatresults <- rbind(l11, l12, l13, l14, l15, l16, l17, l18)

# plots
p1 = blandr.draw(predict_enet(l1_fat_male_lasso, dxa_test_male), 
                 dxa_test_male[,'ha1q34_10al1l4_fat1'], lowest_y_axis = -10000, highest_y_axis = 10000,
                 plotTitle = "L1-L4 fat mass (g), male, Full LASSO", ciShading = FALSE, ciDisplay = FALSE) 
p2 = blandr.draw(predict_enet(l1_fat_female_lasso, dxa_test_female), 
                 dxa_test_female[,'ha1q34_10al1l4_fat1'], lowest_y_axis = -10000, highest_y_axis = 10000,
                 plotTitle = "L1-L4 fat mass (g), female, Full LASSO", ciShading = FALSE, ciDisplay = FALSE) 


p3 = blandr.draw(1000*dxa_test_male[,'ha1q37_11ii_seg_tr_mass'], 
                 dxa_test_male[,'ha1q34_10al1l4_fat1'], lowest_y_axis = -10000, highest_y_axis = 10000,
                 plotTitle = "L1-L4 fat mass (g), male, Tanita", ciShading = FALSE, ciDisplay = FALSE) 
p4 = blandr.draw(1000*dxa_test_female[,'ha1q37_11ii_seg_tr_mass'], 
                 dxa_test_female[,'ha1q34_10al1l4_fat1'], lowest_y_axis = -10000, highest_y_axis = 10000,
                 plotTitle = "L1-L4 fat mass (g), female, Tanita", ciShading = FALSE, ciDisplay = FALSE) 
...
# Outcome = L1-L4 lean mass, ha1q34_10bl1l4_lean1

# Models
l1_lean_male_lasso <- make_lasso('ha1q34_10bl1l4_lean1', 'male')
l1_lean_male_rf <- make_rf('ha1q34_10bl1l4_lean1', 'male')
l1_lean_male_xgb <- make_xgb('ha1q34_10bl1l4_lean1', 'male')
l1_lean_female_lasso <- make_lasso('ha1q34_10bl1l4_lean1', 'female')
l1_lean_female_rf <- make_rf('ha1q34_10bl1l4_lean1', 'female')
l1_lean_female_xgb <- make_xgb('ha1q34_10bl1l4_lean1', 'female')

# Performance
l1l1 <- train_test_perf(1000*dxa_train_male[,'ha1q37_11iii_seg_tr_free_mass'], 
                        1000*dxa_test_male[,'ha1q37_11iii_seg_tr_free_mass'], 
                        'ha1q34_10bl1l4_lean1', 'male')
l1l2 <- train_test_perf(predict_enet(l1_lean_male_lasso, dxa_train_male), 
                        predict_enet(l1_lean_male_lasso, dxa_test_male),
                        'ha1q34_10bl1l4_lean1', 'male')
l1l3 <- train_test_perf(predict(l1_lean_male_rf, dxa_train_male)$predictions, 
                        predict(l1_lean_male_rf, dxa_test_male)$predictions,
                        'ha1q34_10bl1l4_lean1', 'male')
l1l4 <- train_test_perf(predict(l1_lean_male_xgb, dxa_train_male), 
                        predict(l1_lean_male_xgb, dxa_test_male),
                        'ha1q34_10bl1l4_lean1', 'male')


l1l5 <- train_test_perf(1000*dxa_train_female[,'ha1q37_11iii_seg_tr_free_mass'], 
                        1000*dxa_test_female[,'ha1q37_11iii_seg_tr_free_mass'], 
                        'ha1q34_10bl1l4_lean1', 'female')
l1l6 <- train_test_perf(predict_enet(l1_lean_female_lasso, dxa_train_female), 
                        predict_enet(l1_lean_female_lasso, dxa_test_female),
                        'ha1q34_10bl1l4_lean1', 'female')
l1l7 <- train_test_perf(predict(l1_lean_female_rf, dxa_train_female)$predictions, 
                        predict(l1_lean_female_rf, dxa_test_female)$predictions,
                        'ha1q34_10bl1l4_lean1', 'female')
l1l8 <- train_test_perf(predict(l1_lean_female_xgb, dxa_train_female), 
                        predict(l1_lean_female_xgb, dxa_test_female),
                        'ha1q34_10bl1l4_lean1', 'female')

# plots
p1 = blandr.draw(predict_enet(l1_lean_male_lasso, dxa_test_male), 
                 dxa_test_male[,'ha1q34_10bl1l4_lean1'],
                 plotTitle = "L1-L4 lean mass (g), male, Full LASSO", ciShading = FALSE, ciDisplay = FALSE) 
p2 = blandr.draw(predict_enet(l1_lean_female_lasso, dxa_test_female), 
                 dxa_test_female[,'ha1q34_10bl1l4_lean1'],
                 plotTitle = "L1-L4 lean mass (g), female, Full LASSO", ciShading = FALSE, ciDisplay = FALSE) 


p3 = blandr.draw(1000*dxa_test_male[,'ha1q37_11iii_seg_tr_free_mass'], 
                 dxa_test_male[,'ha1q34_10bl1l4_lean1'],
                 plotTitle = "L1-L4 lean mass (g), male, Tanita", ciShading = FALSE, ciDisplay = FALSE) 
p4 = blandr.draw(1000*dxa_test_female[,'ha1q37_11iii_seg_tr_free_mass'], 
                 dxa_test_female[,'ha1q34_10bl1l4_lean1'],
                 plotTitle = "L1-L4 lean mass (g), female, Tanita", ciShading = FALSE, ciDisplay = FALSE) 
...
l1leanresults <- rbind(l1l1, l1l2, l1l3, l1l4, l1l5, 
                          l1l6, l1l7, l1l8)



# Outcome = appendicular fat mass, appendic_fat


# Models
app_fat_male_lasso <- make_lasso('appendic_fat', 'male')
app_fat_male_rf <- make_rf('appendic_fat', 'male')
app_fat_male_xgb <- make_xgb('appendic_fat', 'male')
app_fat_female_lasso <- make_lasso('appendic_fat', 'female')
app_fat_female_rf <- make_rf('appendic_fat', 'female')
app_fat_female_xgb <- make_xgb('appendic_fat', 'female')

# Performance
apf1 <- train_test_perf(1000*dxa_train_male[,'ha1q37_7ii_seg_rl_mass'] + 1000*dxa_train_male[,'ha1q37_8ii_seg_ll_mass'] + 1000*dxa_train_male[,'ha1q37_9ii_seg_ra_mass'] + 1000*dxa_train_male[,'ha1q37_10ii_seg_la_mass'], 
                       1000*dxa_test_male[,'ha1q37_7ii_seg_rl_mass'] + 1000*dxa_test_male[,'ha1q37_8ii_seg_ll_mass'] + 1000*dxa_test_male[,'ha1q37_9ii_seg_ra_mass'] + 1000*dxa_test_male[,'ha1q37_10ii_seg_la_mass'], 
                       'appendic_fat', 'male')
apf2 <- train_test_perf(predict_enet(app_fat_male_lasso, dxa_train_male), 
                       predict_enet(app_fat_male_lasso, dxa_test_male),
                       'appendic_fat', 'male')
apf3 <- train_test_perf(predict(app_fat_male_rf, dxa_train_male)$predictions, 
                       predict(app_fat_male_rf, dxa_test_male)$predictions,
                       'appendic_fat', 'male')
apf4 <- train_test_perf(predict(app_fat_male_xgb, dxa_train_male), 
                       predict(app_fat_male_xgb, dxa_test_male),
                       'appendic_fat', 'male')


apf5 <- train_test_perf(1000*dxa_train_female[,'ha1q37_7ii_seg_rl_mass'] + 1000*dxa_train_female[,'ha1q37_8ii_seg_ll_mass'] + 1000*dxa_train_female[,'ha1q37_9ii_seg_ra_mass'] + 1000*dxa_train_female[,'ha1q37_10ii_seg_la_mass'], 
                       1000*dxa_test_female[,'ha1q37_7ii_seg_rl_mass'] + 1000*dxa_test_female[,'ha1q37_8ii_seg_ll_mass'] + 1000*dxa_test_female[,'ha1q37_9ii_seg_ra_mass'] + 1000*dxa_test_female[,'ha1q37_10ii_seg_la_mass'], 
                       'appendic_fat', 'female')
apf6 <- train_test_perf(predict_enet(app_fat_female_lasso, dxa_train_female), 
                       predict_enet(app_fat_female_lasso, dxa_test_female),
                       'appendic_fat', 'female')
apf7 <- train_test_perf(predict(app_fat_female_rf, dxa_train_female)$predictions, 
                       predict(app_fat_female_rf, dxa_test_female)$predictions,
                       'appendic_fat', 'female')
apf8 <- train_test_perf(predict(app_fat_female_xgb, dxa_train_female), 
                       predict(app_fat_female_xgb, dxa_test_female),
                       'appendic_fat', 'female')


apfatresults <- rbind(apf1, apf2, apf3, apf4, apf5,
                   apf6, apf7, apf8)
...
# Plots
p1 = blandr.draw(predict_enet(app_fat_male_lasso, dxa_test_male), 
                 dxa_test_male[,'appendic_fat'],
                 plotTitle = "Appendicular fat mass (g), male, Full LASSO", ciShading = FALSE, ciDisplay = FALSE) 
p2 = blandr.draw(predict_enet(app_fat_female_lasso, dxa_test_female), 
                 dxa_test_female[,'appendic_fat'],
                 plotTitle = "Appendicular fat mass (g), female, Full LASSO", ciShading = FALSE, ciDisplay = FALSE) 


p3 = blandr.draw(1000*dxa_test_male[,'ha1q37_7ii_seg_rl_mass'] + 1000*dxa_test_male[,'ha1q37_8ii_seg_ll_mass'] + 1000*dxa_test_male[,'ha1q37_9ii_seg_ra_mass'] + 1000*dxa_test_male[,'ha1q37_10ii_seg_la_mass'], 
                 dxa_test_male[,'appendic_fat'],
                 plotTitle = "Appendicular fat mass (g), male, Tanita", ciShading = FALSE, ciDisplay = FALSE) 
p4 = blandr.draw(1000*dxa_test_female[,'ha1q37_7ii_seg_rl_mass'] + 1000*dxa_test_female[,'ha1q37_8ii_seg_ll_mass'] + 1000*dxa_test_female[,'ha1q37_9ii_seg_ra_mass'] + 1000*dxa_test_female[,'ha1q37_10ii_seg_la_mass'], 
                 dxa_test_female[,'appendic_fat'],
                 plotTitle = "Appendicular fat mass (g), female, Tanita", ciShading = FALSE, ciDisplay = FALSE) 
...
# Last outcome - appendicular fat percentage, appendic_perc

# Models
app_fat_p_male_lasso <- make_lasso('appendic_perc', 'male')
app_fat_p_male_rf <- make_rf('appendic_perc', 'male')
app_fat_p_male_xgb <- make_xgb('appendic_perc', 'male')
app_fat_p_female_lasso <- make_lasso('appendic_perc', 'female')
app_fat_p_female_rf <- make_rf('appendic_perc', 'female')
app_fat_p_female_xgb <- make_xgb('appendic_perc', 'female')

# Performance
apfp1 <- train_test_perf((dxa_train_male[,'ha1q37_7ii_seg_rl_mass'] + dxa_train_male[,'ha1q37_8ii_seg_ll_mass'] + dxa_train_male[,'ha1q37_9ii_seg_ra_mass'] + dxa_train_male[,'ha1q37_10ii_seg_la_mass']) / (dxa_train_male[,'ha1q37_7ii_seg_rl_mass'] + dxa_train_male[,'ha1q37_8ii_seg_ll_mass'] + dxa_train_male[,'ha1q37_9ii_seg_ra_mass'] + dxa_train_male[,'ha1q37_10ii_seg_la_mass'] + dxa_train_male[,'ha1q37_7iii_seg_rl_free_mass'] + dxa_train_male[,'ha1q37_8iii_seg_ll_free_mass'] + dxa_train_male[,'ha1q37_9iii_seg_ra_free_mass'] + dxa_train_male[,'ha1q37_10iii_seg_la_free_mass']), 
                         (dxa_test_male[,'ha1q37_7ii_seg_rl_mass'] + dxa_test_male[,'ha1q37_8ii_seg_ll_mass'] + dxa_test_male[,'ha1q37_9ii_seg_ra_mass'] + dxa_test_male[,'ha1q37_10ii_seg_la_mass']) / (dxa_test_male[,'ha1q37_7ii_seg_rl_mass'] + dxa_test_male[,'ha1q37_8ii_seg_ll_mass'] + dxa_test_male[,'ha1q37_9ii_seg_ra_mass'] + dxa_test_male[,'ha1q37_10ii_seg_la_mass'] + dxa_test_male[,'ha1q37_7iii_seg_rl_free_mass'] + dxa_test_male[,'ha1q37_8iii_seg_ll_free_mass'] + dxa_test_male[,'ha1q37_9iii_seg_ra_free_mass'] + dxa_test_male[,'ha1q37_10iii_seg_la_free_mass']), 
                        'appendic_perc', 'male')
apfp2 <- train_test_perf(predict_enet(app_fat_p_male_lasso, dxa_train_male), 
                        predict_enet(app_fat_p_male_lasso, dxa_test_male),
                        'appendic_perc', 'male')
apfp3 <- train_test_perf(predict(app_fat_p_male_rf, dxa_train_male)$predictions, 
                        predict(app_fat_p_male_rf, dxa_test_male)$predictions,
                        'appendic_perc', 'male')
apfp4 <- train_test_perf(predict(app_fat_p_male_xgb, dxa_train_male), 
                        predict(app_fat_p_male_xgb, dxa_test_male),
                        'appendic_perc', 'male')


apfp5 <- train_test_perf((dxa_train_female[,'ha1q37_7ii_seg_rl_mass'] + dxa_train_female[,'ha1q37_8ii_seg_ll_mass'] + dxa_train_female[,'ha1q37_9ii_seg_ra_mass'] + dxa_train_female[,'ha1q37_10ii_seg_la_mass']) / (dxa_train_female[,'ha1q37_7ii_seg_rl_mass'] + dxa_train_female[,'ha1q37_8ii_seg_ll_mass'] + dxa_train_female[,'ha1q37_9ii_seg_ra_mass'] + dxa_train_female[,'ha1q37_10ii_seg_la_mass'] + dxa_train_female[,'ha1q37_7iii_seg_rl_free_mass'] + dxa_train_female[,'ha1q37_8iii_seg_ll_free_mass'] + dxa_train_female[,'ha1q37_9iii_seg_ra_free_mass'] + dxa_train_female[,'ha1q37_10iii_seg_la_free_mass']), 
                         (dxa_test_female[,'ha1q37_7ii_seg_rl_mass'] + dxa_test_female[,'ha1q37_8ii_seg_ll_mass'] + dxa_test_female[,'ha1q37_9ii_seg_ra_mass'] + dxa_test_female[,'ha1q37_10ii_seg_la_mass']) / (dxa_test_female[,'ha1q37_7ii_seg_rl_mass'] + dxa_test_female[,'ha1q37_8ii_seg_ll_mass'] + dxa_test_female[,'ha1q37_9ii_seg_ra_mass'] + dxa_test_female[,'ha1q37_10ii_seg_la_mass'] + dxa_test_female[,'ha1q37_7iii_seg_rl_free_mass'] + dxa_test_female[,'ha1q37_8iii_seg_ll_free_mass'] + dxa_test_female[,'ha1q37_9iii_seg_ra_free_mass'] + dxa_test_female[,'ha1q37_10iii_seg_la_free_mass']), 
                        'appendic_perc', 'female')
apfp6 <- train_test_perf(predict_enet(app_fat_p_female_lasso, dxa_train_female), 
                        predict_enet(app_fat_p_female_lasso, dxa_test_female),
                        'appendic_perc', 'female')
apfp7 <- train_test_perf(predict(app_fat_p_female_rf, dxa_train_female)$predictions, 
                        predict(app_fat_p_female_rf, dxa_test_female)$predictions,
                        'appendic_perc', 'female')
apfp8 <- train_test_perf(predict(app_fat_p_female_xgb, dxa_train_female), 
                        predict(app_fat_p_female_xgb, dxa_test_female),
                        'appendic_perc', 'female')


apfatpresults <- rbind(apfp1, apfp2, apfp3, apfp4, apfp5,
                      apfp6, apfp7, apfp8)
...
# Plots
p1 = blandr.draw(predict_enet(app_fat_p_male_lasso, dxa_test_male), 
                 dxa_test_male[,'appendic_perc'],
                 plotTitle = "Appendicular fat percentage (%), male, Full LASSO", ciShading = FALSE, ciDisplay = FALSE) 
p2 = blandr.draw(predict_enet(app_fat_p_female_lasso, dxa_test_female), 
                 dxa_test_female[,'appendic_perc'],
                 plotTitle = "Appendicular fat percentage (%), female, Full LASSO", ciShading = FALSE, ciDisplay = FALSE) 


p3 = blandr.draw(
  (dxa_test_male[,'ha1q37_7ii_seg_rl_mass'] + dxa_test_male[,'ha1q37_8ii_seg_ll_mass'] + dxa_test_male[,'ha1q37_9ii_seg_ra_mass'] + dxa_test_male[,'ha1q37_10ii_seg_la_mass']) / (dxa_test_male[,'ha1q37_7ii_seg_rl_mass'] + dxa_test_male[,'ha1q37_8ii_seg_ll_mass'] + dxa_test_male[,'ha1q37_9ii_seg_ra_mass'] + dxa_test_male[,'ha1q37_10ii_seg_la_mass'] + dxa_test_male[,'ha1q37_7iii_seg_rl_free_mass'] + dxa_test_male[,'ha1q37_8iii_seg_ll_free_mass'] + dxa_test_male[,'ha1q37_9iii_seg_ra_free_mass'] + dxa_test_male[,'ha1q37_10iii_seg_la_free_mass']), 
  dxa_test_male[,'appendic_perc'],
                 plotTitle = "Appendicular fat percentage (%), male, Tanita", ciShading = FALSE, ciDisplay = FALSE) 
p4 = blandr.draw(
  (dxa_test_female[,'ha1q37_7ii_seg_rl_mass'] + dxa_test_female[,'ha1q37_8ii_seg_ll_mass'] + dxa_test_female[,'ha1q37_9ii_seg_ra_mass'] + dxa_test_female[,'ha1q37_10ii_seg_la_mass']) / (dxa_test_female[,'ha1q37_7ii_seg_rl_mass'] + dxa_test_female[,'ha1q37_8ii_seg_ll_mass'] + dxa_test_female[,'ha1q37_9ii_seg_ra_mass'] + dxa_test_female[,'ha1q37_10ii_seg_la_mass'] + dxa_test_female[,'ha1q37_7iii_seg_rl_free_mass'] + dxa_test_female[,'ha1q37_8iii_seg_ll_free_mass'] + dxa_test_female[,'ha1q37_9iii_seg_ra_free_mass'] + dxa_test_female[,'ha1q37_10iii_seg_la_free_mass']), 
  dxa_test_female[,'appendic_perc'],
                 plotTitle = "Appendicular fat percentage (%), female, Tanita", ciShading = FALSE, ciDisplay = FALSE) 
...
trunkfatresults[,1] <- round(trunkfatresults[,1]/1000, 2)
trunkfatresults[,2] <- round(trunkfatresults[,2]/1000, 3)
trunkfatresults[,3] <- round(trunkfatresults[,3]*100, 2)
trunkfatresults[,4] <- round(trunkfatresults[,4], 3)
trunkfatresults[,5] <- round(trunkfatresults[,5]/1000, 2)
trunkfatresults[,6] <- round(trunkfatresults[,6]/1000, 3)
trunkfatresults[,7] <- round(trunkfatresults[,7]*100, 2)
trunkfatresults[,8] <- round(trunkfatresults[,8], 3)


trunkleanresults[,1] <- round(trunkleanresults[,1]/1000, 2)
trunkleanresults[,2] <- round(trunkleanresults[,2]/1000, 3)
trunkleanresults[,3] <- round(trunkleanresults[,3]*100, 2)
trunkleanresults[,4] <- round(trunkleanresults[,4], 3)
trunkleanresults[,5] <- round(trunkleanresults[,5]/1000, 2)
trunkleanresults[,6] <- round(trunkleanresults[,6]/1000, 3)
trunkleanresults[,7] <- round(trunkleanresults[,7]*100, 2)
trunkleanresults[,8] <- round(trunkleanresults[,8], 3)

l1fatresults[,1] <- round(l1fatresults[,1]/1000, 2)
l1fatresults[,2] <- round(l1fatresults[,2]/1000, 3)
l1fatresults[,3] <- round(l1fatresults[,3]*100, 2)
l1fatresults[,4] <- round(l1fatresults[,4], 3)
l1fatresults[,5] <- round(l1fatresults[,5]/1000, 2)
l1fatresults[,6] <- round(l1fatresults[,6]/1000, 3)
l1fatresults[,7] <- round(l1fatresults[,7]*100, 2)
l1fatresults[,8] <- round(l1fatresults[,8], 3)

l1leanresults[,1] <- round(l1leanresults[,1]/1000, 2)
l1leanresults[,2] <- round(l1leanresults[,2]/1000, 3)
l1leanresults[,3] <- round(l1leanresults[,3]*100, 2)
l1leanresults[,4] <- round(l1leanresults[,4], 3)
l1leanresults[,5] <- round(l1leanresults[,5]/1000, 2)
l1leanresults[,6] <- round(l1leanresults[,6]/1000, 3)
l1leanresults[,7] <- round(l1leanresults[,7]*100, 2)
l1leanresults[,8] <- round(l1leanresults[,8], 3)

apfatresults[,1] <- round(apfatresults[,1]/1000, 2)
apfatresults[,2] <- round(apfatresults[,2]/1000, 3)
apfatresults[,3] <- round(apfatresults[,3]*100, 2)
apfatresults[,4] <- round(apfatresults[,4], 3)
apfatresults[,5] <- round(apfatresults[,5]/1000, 2)
apfatresults[,6] <- round(apfatresults[,6]/1000, 3)
apfatresults[,7] <- round(apfatresults[,7]*100, 2)
apfatresults[,8] <- round(apfatresults[,8], 3)

apfatpresults[,1] <- round(apfatpresults[,1], 3)
apfatpresults[,2] <- round(apfatpresults[,2], 3)
apfatpresults[,3] <- round(apfatpresults[,3]*100, 2)
apfatpresults[,4] <- round(apfatpresults[,4], 3)
apfatpresults[,5] <- round(apfatpresults[,5], 3)
apfatpresults[,6] <- round(apfatpresults[,6], 3)
apfatpresults[,7] <- round(apfatpresults[,7]*100, 2)
apfatpresults[,8] <- round(apfatpresults[,8], 3)



# EXPORT RESULTS
write.csv(trunkfatresults, 'extra_trunkfatmasslessints.csv')
write.csv(trunkleanresults, 'extra_trunkleanmasslessints.csv')
write.csv(l1fatresults, 'extra_l1fatmasslessints.csv')
write.csv(l1leanresults, 'extra_l1leanmasslessints.csv')
write.csv(apfatresults, 'extra_appfatmasslessints.csv')
write.csv(apfatpresults, 'extra_appfatperclessints.csv')
